rec {
  shellHook-for =
    { package, pythoneda-shared-pythoneda-domain, python, nixpkgsRelease }: ''
      ...
      echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-shared-pythoneda/domain-artifact/tree/$PVERSION\033[0m";
      echo -e " \033[32m| |_) | |_| | |_| | | | (_) | | | |\033[34m  __/\033[35m (_| |\033[36m (_| |\033[34mhttps://github.com/pythoneda-shared-pythoneda/domain\033[0m";
      ...
      echo -e " \033[32m| |     __/ |             \033[37mARTIFACT FOR              \033[36mhttps://docs.python.org/$PYVERSION\033[0m";
      echo -e " \033[32m|_|\033[37mA\033[31m \033[36mD\033[32m |___/            \033[33mPYTHONEDA DOMAIN            \033[37mhttps://patreon.com/rydnr\033[0m";
      echo;
      echo " Thank you for using pythoneda-shared-pythoneda/domain-artifact, PythonEDA in general, and for your appreciation of free software.";
      echo;
